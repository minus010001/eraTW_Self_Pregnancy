...
## Phase 3b：ADD_GAME_INFO 系统（CUSTOM_COM0 Play Game）
...
| 2 | 注册 ADD_GAME_INFO CLASS | GETOBJ.ERB 添加 SETLIST_EXIST | ⬜ |
...
| 9 | 移植 ADD_BANQUET_ACTIVITY_ALLOWED | Add_Banquet.ERB 中添加 | ⬜ |
